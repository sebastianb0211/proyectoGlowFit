...
let planGratuitoClick = document.getElementById("planGratuitoClick")
function mostrarVentanaGifGratis(){
  Swal.fire({
    icon: "success",
    title: "Adquirido",
...
function ocultarContenidoTonificar(){
 ...
 contenidoRecomendacionTonificar.style.display="none"
  ...
  function ocultarContenidoPeso(){
    ...
    let mesUnoP = document.getElementById("mesUnoP")
    let mesDosP = document.getElementById("mesDosP")
    let mesTresP = document.getElementById("mesTresP")
   ...
   let mesUnoRa = document.getElementById("mesUnoRa")
   let mesDosRa = document.getElementById("mesDosRa")
   let mesTresRa = document.getElementById("mesTresRa")

 // recomendaciones por mes Adelgazar
   let primerMesRecomendacionesAdelgazar = document.getElementById("primerMesRecomendacionesAdelgazar")
   let segundoMesRecomendacionesAdelgazar = document.getElementById("segundoMesRecomendacionesAdelgazar")
   let tercerMesRecomendacionesAdelgazar = document.getElementById("tercerMesRecomendacionesAdelgazar")


   function ocultarMesesRecomendacion(){
    primerMesRecomendacionesAdelgazar.style.display="none"
    segundoMesRecomendacionesAdelgazar.style.display="none"
    tercerMesRecomendacionesAdelgazar.style.display="none"
   }
   function PrimerMesRecomendacionAdelgazar(){
    ocultarMesesRecomendacion()
    primerMesRecomendacionesAdelgazar.style.display="flex"
   }

   function segundoMesRecomendacionAdelgazar(){
    ocultarMesesRecomendacion()
    segundoMesRecomendacionesAdelgazar.style.display="flex"
   }

   function tercerMesRecomendacionAdelgazar(){
    ocultarMesesRecomendacion()
    tercerMesRecomendacionesAdelgazar.style.display="flex"
   }

   mesUnoRa.addEventListener("click",PrimerMesRecomendacionAdelgazar)
   mesDosRa.addEventListener("click",segundoMesRecomendacionAdelgazar)
   mesTresRa.addEventListener("click",tercerMesRecomendacionAdelgazar)

   //Recomendaciones por mes tonificar

   let primerMesRecomendacionesTonificar = document.getElementById("primerMesRecomendacionesTonificar")
   let segundoMesRecomendacionesTonificar = document.getElementById("segundoMesRecomendacionesTonificar")
   let tercerMesRecomendacionesTonificar = document.getElementById("tercerMesRecomendacionesTonificar")

   function ocultarMesesRecomendacionTonificar(){
    primerMesRecomendacionesTonificar.style.display="none"
    segundoMesRecomendacionesTonificar.style.display="none"
    tercerMesRecomendacionesTonificar.style.display="none"
   }

   function PrimerMesRecomendacionTonificar(){
    ocultarMesesRecomendacionTonificar()
    primerMesRecomendacionesTonificar.style.display="flex"
   }

   function segundoMesRecomendacionTonificar(){
    ocultarMesesRecomendacionTonificar()
    segundoMesRecomendacionesTonificar.style.display="flex"
   }

   function tercerMesRecomendacionTonificar(){
    ocultarMesesRecomendacionTonificar()
    tercerMesRecomendacionesTonificar.style.display="flex"
   }

  let mesUnoRt = document.getElementById("mesUnoRt")
  let mesDosRt = document.getElementById("mesDosRt")
  let mesTresRt = document.getElementById("mesTresRt")

  mesUnoRt.addEventListener("click",PrimerMesRecomendacionTonificar)
  mesDosRt.addEventListener("click",segundoMesRecomendacionTonificar)
  mesTresRt.addEventListener("click",tercerMesRecomendacionTonificar)

  // Recomendaciones por mes para ganar peso

  let primerMesRecomendacionesPeso = document.getElementById("primerMesRecomendacionesPeso")
  let segundoMesRecomendacionesPeso = document.getElementById("segundoMesRecomendacionesPeso")
  let tercerMesRecomendacionesPeso = document.getElementById("tercerMesRecomendacionesPeso")

  function ocultarMesesRecomendacionPeso(){
    primerMesRecomendacionesPeso.style.display="none"
    segundoMesRecomendacionesPeso.style.display="none"
    tercerMesRecomendacionesPeso.style.display="none"
  }

  function PrimerMesRecomendacionPeso(){
    ocultarMesesRecomendacionPeso()
    primerMesRecomendacionesPeso.style.display="flex"
  }
  
  function segundoMesRecomendacionPeso(){
    ocultarMesesRecomendacionPeso()
    segundoMesRecomendacionesPeso.style.display="flex"
  }

  function tercerMesRecomendacionPeso(){
    ocultarMesesRecomendacionPeso()
    tercerMesRecomendacionesPeso.style.display="flex"
  }

  let mesUnoRp = document.getElementById("mesUnoRp")
  let mesDosRp = document.getElementById("mesDosRp")
  let mesTresRp = document.getElementById("mesTresRp")

  mesUnoRp.addEventListener("click",PrimerMesRecomendacionPeso)
  mesDosRp.addEventListener("click",segundoMesRecomendacionPeso)
  mesTresRp.addEventListener("click",tercerMesRecomendacionPeso)